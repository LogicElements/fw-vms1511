...
/**
 * Initialize independent watchdog with refresh period < 1.5s
 * @return status
 */
...
/**
 * Set application reset vector
 *
 * Remap reset vector from flash to RAM and copy our reset vector into
 * correct beginning of RAM
 */
 ...
 * @param address Beginning address of image
 * @return Status OK if consistency is OK, ERROR if not
 */
